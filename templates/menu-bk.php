...
<div class="evs_user">
                         ...
                         <!-- <form method="post" action="" id="search_form">-->
                            	...
                            	<input type="text" name="search-text" id="search-text" list="list-location" class="form-control" value="<?php echo $value;?>" autocomplete="off" style="width:300px" placeholder="Search your property"/>
                        ...
                        <li><a href="customer-portal.php" <?php if($page == "customer-portal.php"){?>class="active"<?php } ?>>Customers</a></li>
