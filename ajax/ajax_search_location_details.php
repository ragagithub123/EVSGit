...
$getdetails=$db->joinquery("SELECT location.locationid,location.photoid,location.`unitnum`,location.`street`,location.`suburb`,location.`city`,location.`jobstatusid`,location.`locationstatusid`,location.`booking_date`,location.`booking_status`,location.`booking_notes`,location.`alarm_Type`,customer.customerid,customer.firstname,customer.lastname,customer.email,customer.phone FROM location,customer WHERE location.customerid=customer.customerid AND location.`locationid`=".$_POST['locationid']."");
                ...
                <div class="drag-pop-info">
                        	...
                        	<div class="tile-inner-content tin_two" style="padding:0; margin-bottom: 12px;">
                               ...
                               <?php $time_date= date('d-m-Y H:i',strtotime($row_cards['booking_date']));
                                 ...
                                 <?php
																																	...
																																	?>
                                 <h6 class="waiting"><?php echo $exp_time[1];?> <span><?php echo $exp_time[0];?></span> <i class="fa fa-clock-o"></i></h6></li><?php } else if($row_cards['booking_date'] != "0000-00-00 00:00:00"){
                    ...
                    <div class="card-list-menu">
                    	<ul class="card-list-o">
                            <li><a href="#" class="btn-info cust-edit-btn" id="edit-btn-popup-search" data-toggle="modal" data-target="#myModalSearchprop"><i class="fa fa-pencil"></i>EDIT</a></li>
                          <!-- <li> <a id="datetimepicker" href="javascript:void(0)">
                            ...
                            <li class="date-pick-popup">
                                ...
                                <div class="timepick_popup">
                                	<div class="form-group">
                                		<input id="datetimepicker" type="text" class="form-control datetimepicker" value="<?php echo $row_cards['booking_date'];?>">
                                    </div>
                            ...
                            <li><a href="#"><i class="glyphicon glyphicon-search"></i> Summary</a></li>
                        </ul>
                    </div>
                </div>
...
$download_file=$attach_file."...".$explode_file[1];}else
																								{
																									$download_file=$row_attach['attachment'];}

                        	echo '<h5><a href='.$gDownlaodurl.$row_attach['attachment'].' download ='.$row_attach['attachment'].' target="_blank">'.$download_file.'</a></h5>
...
<div id="myModalSearchprop" class="modal fade" role="dialog">
                           ...
                           <div class="modal-body">
                             ...
                             <img src="<?php echo $gPhotoURL.$row_cards['photoid'].".jpg";?>"  class="img-responsive" style="width:100px;height:100px" id="userimage-edit">
                                     ...
                                     <?php
																																				...
																																				}else {?> <img  class="img-responsive" style="width:100px;height:100px" id="userimage-edit"> <?php }?><input type="file" name="locimage" id="locimage-edit" onchange="readURLEdit(this)"/></td></tr>
                             <tr><th>Unitnum</th><td><input type="text" name="unitnum" id="unitnum-edit" class="form-control" value="<?php echo $row_cards['unitnum'];?>"/></td></tr>
                             <tr><th>Street</th><td><input type="text" name="street" id="street-edit" class="form-control" value="<?php echo $row_cards['street'];?>"/></td></tr>
                             <tr><th>Suburb</th><td><input type="text" name="suburb" id="suburb-edit" class="form-control" value="<?php echo $row_cards['suburb'];?>"/></td></tr>
                             <tr><th>City</th><td><input type="text" name="city" id="city-edit" class="form-control" value="<?php echo $row_cards['city'];?>"/></td></tr>
                             <tr><th>Customer Firstname</th><td><input type="text" name="firstname" id="firstname-edit" class="form-control" value="<?php echo $row_cards['firstname'];?>"/></td></tr>
                             <tr><th>Customer Lastname</th><td><input type="text" name="lastname" id="lastname-edit" class="form-control" value="<?php echo $row_cards['lastname'];?>"/></td></tr>
                             <tr><th>Customer Phone</th><td><input type="text" name="phone" id="phone-edit" class="form-control" value="<?php echo $row_cards['phone'];?>"/></td></tr>
                             <tr><th>Customer Email</th><td><input type="text" name="email" id="email-edit" class="form-control" value="<?php echo $row_cards['email'];?>"/></td></tr>
                              <tr><th>Quote Status</th><td>
                              <?php
																														while($row_status=mysqli_fetch_array($get_status))
																														{
																															 if($row_status['locationstatusid']==$row_cards['locationstatusid'])
																															{
                            ...
                            <tr><td><input type="hidden" id="loc-status" value="1" /></td></tr>
                             <tr>
