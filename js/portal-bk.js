...
function update(locationid) {
	...
	$.ajax({
		...
		data: { data: info, locationid: locationid, pagestatus: $("input[name=page-status]").val() },
		success: function (data) {
...
/*$(document).on("click",".rad-status",function(){
		$.ajax({
type: "POST",
